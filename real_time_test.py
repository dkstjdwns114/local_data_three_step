...
def close(today_str, day1_str, day2_str, day3_str, day4_str, day5_str, day6_str, day7_str):
    ...
    local_real_time_close = localWeekData['test_close']
    ...
    if jsonObj['rows']:
        ...
        for item in jsonObj['rows']['row']:
            if item['dcbYmd'] == day1_str or item['dcbYmd'] == day2_str or item['dcbYmd'] == day3_str or item['dcbYmd'] == day4_str or item['dcbYmd'] == day5_str or item['dcbYmd'] == day6_str or item['dcbYmd'] == day7_str:
                is_exist = local_real_time_close.find_one(
...
def today_open(day1_str, day2_str, day3_str, day4_str, day5_str, day6_str, day7_str):
    ...
    local_real_time_open = localWeekData['test_open']
    ...
    if jsonObj['rows']:
        ...
        for item in jsonObj['rows']['row']:
            ...
            is_exist = local_real_time_open.find_one({"$and": [{"mgtNo": item['mgtNo']}, {"store_name": item['bplcNm']}]})
            if is_exist is None:
                cnt += 1
                city_name = ""
                category_name = ""
